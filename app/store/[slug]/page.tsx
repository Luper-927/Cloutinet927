...
export async function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  const { profile } = data
  return {
    title: profile.business_name + (profile.location ? ' | ' + profile.location : '') + ' | Cloutinet',
    description: profile.tagline || ('Find products and services from ' + profile.business_name + ' on Cloutinet.'),
  }
}
